...
<head>
    ...
    <title> Krishna Multispeciality Hospital </title>
    ...
    <!-- ################# Header Starts Here#######################--->
      ...
      <header id="menu-jk">
        ...
        <div id="nav-head" class="header-nav">
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-3  col-sm-12" style="color:#000;font-weight:bold; font-size:40px; margin-top: 1% !important; overflow:hidden; text-overflow:ellipsis; line-height:1.1; text-align:center;">KMH
            ...
            <div class="carousel-inner">
                <div class="carousel-item ">
                    ...
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown">Krishna Multispeciality Hospital</h5>
